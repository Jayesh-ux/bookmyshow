...
public class ticketService {
    ...
    public String bookTicket(bookTicketRqst ticketDto) throws Exception {
        ...
        ticket.setAmtPaid(totalAmt);
        ticket.setMovieName(show.getMovie().getMovieName());
        ticket.setTheaterNameAndAdd(show.getTheater().getTheaterName() + " " + show.getTheater().getTheaterAddress());
        ticket.setSeats(ticketDto.getSeatNo().toString());
